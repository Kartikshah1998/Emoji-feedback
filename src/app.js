...
const REACTIONS = [
  ...
  { label: "Fair", src: require('./assets/sad.png'), bigSrc: require('./assets/sad_big.png') },
  { label: "Satisfied", src: require('./assets/ambitious.png'), bigSrc: require('./assets/ambitious_big.png') },
  { label: "Excellent", src: require('./assets/smile.png'), bigSrc: require('./assets/smile_big.png') },
